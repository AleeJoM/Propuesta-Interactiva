...
export const RomanticButton: React.FC<RomanticButtonProps> = ({
  ...
  const baseClasses = 'px-6 py-3 rounded-full font-medium transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-pink-300';
  const variantClasses = variant === 'primary' 
    ? 'bg-gradient-to-r from-pink-500 to-rose-500 text-white shadow-lg hover:from-pink-600 hover:to-rose-600'
    : 'bg-white text-rose-600 border-2 border-rose-500 hover:bg-rose-500 hover:text-white';
